...
public class PurchaseController {
	...
	@GetMapping("dop")
	public List<PurchaseEntity> getAllPurchasebyDate(@RequestParam String dop)
	{
		return service.findByDop(dop);
	}
	
	@GetMapping("category")
	public List<PurchaseEntity> getAllPurchasebyCategory(@RequestParam String category)
	{
